defmodule AlibabaCloudKit.OSS.ObjectTest do
  ...
  test "presign_post_object_v1/3", %{
    ...
    assert %{
             signature: "rOLRLFOeZRsJ+8WA6wAiPLCda14=",
             policy:
               ""
           } == Object.presign_post_object_v1(conditions, seconds_to_expire, opts)
  end
end
