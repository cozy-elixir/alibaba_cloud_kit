defmodule AliyunOpenAPI.HTTP.Client.Finch do
  @moduledoc """
  ...
  If a name different from `AliyunOpenAPI.Finch` is used, or you want to
  ...
  alias AliyunOpenAPI.HTTP.Response

  @behaviour AliyunOpenAPI.HTTP.Client
  ...
  defp finch_name() do
    Application.get_env(:aliyun_open_api, :finch_name, AliyunOpenAPI.Finch)
  end
end
