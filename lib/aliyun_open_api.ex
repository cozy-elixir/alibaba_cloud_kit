defmodule AliyunOpenAPI do
  ...
  * `AliyunOpenAPI.Specs.RPC`
  * `AliyunOpenAPI.Specs.ROA`
  * `AliyunOpenAPI.Specs.OSS`
  ...
  * STS Token
  ...
  The `AliyunOpenAPI.Specs.*` modules will try their best to include relevant
